...
export default function Header({ user, onNavigateToView, onLogout, unreadCount = 3 }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-b border-surface-container h-16 px-4 md:px-8 flex items-center justify-between shadow-sm transition-all">
          ...
          <AnimatePresence>
            {isNotificationsOpen && (
              <motion.div
                ...
                className="absolute right-0 mt-3 w-80 sm:w-96 bg-white rounded-2xl shadow-[0px_10px_40px_rgba(0,0,0,0.12)] border border-surface-container overflow-hidden z-50"
              >
